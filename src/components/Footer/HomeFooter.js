      ...
      <div className="footer-top">
        <div className="top-container">
          ...
          <div className="logo-container">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 166.92 45.53" className="logo" aria-labelledby="optomrx-logo-footer">
              <title id="optomrx-logo-footer">OptomRx</title>
            ...
            <p className="coffee"><a target="_blank" rel="noreferrer" href="https://www.buymeacoffee.com/optomrx">Buy me a coffee! (helps with server costs)</a></p>
          </div>
        </div>
      </div>
    </StyledHomeFooter>
