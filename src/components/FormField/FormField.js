...
const FormField = (props) => {
  const { fieldType, id, name, label, value, placeholder, onChange, className, alert, subAlert, maxlength, checked, enterFunc } = props;
        ...
        <div className="alert-container">
          ...
          {(alert.type === 'success') && 
            (<svg xmlns="http://www.w3.org/2000/svg" className="alert-icon alert-icon--success" viewBox="0 0 512 512" width="17px">
              <title>Checkmark Circle</title>
              <path d="M448 256c0-106-86-192-192-192S64 150 64 256s86 192 192 192 192-86 192-192z" fill="none" stroke="#1b7e46" strokeMiterlimit="10" strokeWidth="32"/>
              <path fill="none" stroke="#1b7e46" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M352 176L217.6 336 160 272"/>
            </svg>)
          }
          {(alert.type === 'neutral') && 
