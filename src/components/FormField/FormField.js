    ...
    <StyledFormField className={className}>
      ...
      // Consider adding a cross icon above in the label for visually impaired users
        <div className="alert-container">
          ...
          {(alert.type === 'success') && 
            (<svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512" width="18px">
              <title>Checkmark Circle</title>
              <path d="M448 256c0-106-86-192-192-192S64 150 64 256s86 192 192 192 192-86 192-192z" fill="none" stroke="#219653" strokeMiterlimit="10" strokeWidth="32"/>
              <path fill="none" stroke="#219653" strokeLinecap="round" strokeLinejoin="round" strokeWidth="32" d="M352 176L217.6 336 160 272"/>
            </svg>)
          }
          {(alert.type === 'neutral') && 
            (<svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512" width="18px">
