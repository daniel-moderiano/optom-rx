...
const Tooltip = ({ showTooltip, tooltipText }) => {
  return (
    <StyledTooltip className={`tooltip ${showTooltip ? 'show' : 'hide'}`} aria-label="Show more information on brand name vs active ingredient prescribing for this medication">
