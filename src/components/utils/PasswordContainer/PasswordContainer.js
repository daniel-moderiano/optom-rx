...
const PasswordContainer = ({ children, showPassword, handleClick }) => {
  return (
    <StyledPasswordContainer className="PasswordContainer">
      ...
      <button className="toggle-password" type="button" aria-label={`${showPassword ? 'Show password as plain text. Warning: this will display your password on the screen.' : 'Hide password.'}`} onClick={handleClick}>
