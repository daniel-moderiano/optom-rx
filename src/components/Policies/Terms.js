  ...
  return (
    <StyledPolicy className="Terms">
      ...
      <section className="Terms__section">
        ...
        <p className="Terms__paragraph">
          You agree to indemnify, defend and hold harmless OptomRx and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
        </p>
      </section>
      ...
      <section className="Terms__section">
        ...
        <p className="Terms__paragraph">
          These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of the State of South Australia, Australia.
        </p>
      </section>
