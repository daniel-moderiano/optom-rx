...
const Indications = ({ indicationsData }) => {
  ...
  console.log(indicationsData);

  // When the indication data for a drug changes in the Rx form, update the indications component here with the valid indications HTML
  useEffect(() => {
    ...
    formatIndications(indicationsData)
  }, [indicationsData]);
