      ...
      <div class="sc-giYglK kquWbv Script">
        ...
        <div class="Script__info">
          ...
          <div class="Script__pbs">
            ...
            <div class="Script__info--section Script__date">Date prescribed: 31/01/2022</div>
          </div>
        </div>

        <div class="PrescriberForm__btns">
          <div class="re-prescribe">
            <svg xmlns="http://www.w3.org/2000/svg" class="icon arrow-icon" viewBox="0 0 512 512"><path d="M448 256L272 88v96C103.57 184 64 304.77 64 424c48.61-62.24 91.6-96 208-96v96z" fill="#ffffff" stroke="currentColor" stroke-linejoin="round" stroke-width="10"></path></svg>
            <span>Re-prescribe</span>
          </div>
          <div class="sc-iCfMLu iLkslw fav-btn">
            <svg class="icon star-icon" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="23px" viewBox="0 0 24 24" width="22px" fill="#ffffff"><g><path d="M0,0h24v24H0V0z" fill="none"></path><path d="M0,0h24v24H0V0z" fill="none"></path></g><g><path d="M12,17.27L18.18,21l-1.64-7.03L22,9.24l-7.19-0.61L12,2L9.19,8.63L2,9.24l5.46,4.73L5.82,21L12,17.27z"></path></g>
            </svg>
